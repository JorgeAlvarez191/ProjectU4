...
const blue = {
    100: '#DAECFF !important',
    200: '#80BFFF !important',
    400: '#3399FF !important',
    600: '#0072E5 !important',
  };
...
type
   ...
   {({ filled, focused }: FormControlUnstyledState) => (
       <React.Fragment>
           <Input id='name' type={type}  className={filled ? 'filled' : ''} required/>
